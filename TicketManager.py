...
class SafetyManager(QMainWindow):
    def __init__(self, clipboard):
        ...
        search_name = QAction("Search by User", self)
        search_name.triggered.connect(lambda: self.filter_table("creator"))
        search_name.setFont(font)
        self.toolbar.addAction(search_name)

        # Search by ticket ID
        search_id = QAction("Search by ID", self)
        search_id.triggered.connect(lambda: self.filter_table("id"))
        search_id.setFont(font)
        self.toolbar.addAction(search_id)
        ...
        self.table4 = self.ui.table_4_Widget
        self.table4.setColumnHidden(6, True)
        ...
        self.ui.delete1Button.clicked.connect(lambda: self.delete_row(self.table_control))
        ...
        self.ui.delete2Button.clicked.connect(lambda: self.delete_row(self.table_control2))
        ...
        self.ui.delete3Button.clicked.connect(lambda: self.delete_row(self.table_control3))
    ...
    def login(self):
        ...
        self.table_control4 = TableController(self.table4, self.client, self.all_data, 4)
        self.table_control.load_table()
        self.table_control2.load_table()
        self.table_control3.load_table()
        self.table_control4.load_table()
        self.toolbar.show()
    ...
    def delete_row(self, table_control):
        # Delete the chosen row
        table_control.delete_row()
        self.refresh(self.table4, 4)
    ...
    def filter_table(self, filter_name: str):
        ...
        match filter_name:
            ...
            case "project":
                ...
                dict_str = "Project"
            case "id":
                filter_str = self.table_control.input_dialog("Search", "Search by Ticket ID (6-digits):")
                dict_str = "Ticket ID"
            case "location":
